...
public class KafkaConfig {
    ...
    private static final String GROUP_ID="my-concumer-group";
    ...
    public static Properties getConcumerConfig(){
        ...
        properties.put(ConsumerConfig.ACKS_CONFIG, "all");

        // Установили класс для сериализации ключей сообщений (String -> byte[])
        properties.put(ConsumerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        // Установили класса сирилизации значений
        properties.put(ConsumerConfig.VALUE_SERIALIZER_CLASS_CONFIG,StringSerializer.class.getName());
